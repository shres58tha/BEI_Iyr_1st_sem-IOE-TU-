...
int main(){
	...
	b=a;
	while (b>0)
		{ rem=b%10;// these two lines are used to extract digits from the number sequentially
		  b=b/10; // these two lines are used to extract digits from the number sequentially
